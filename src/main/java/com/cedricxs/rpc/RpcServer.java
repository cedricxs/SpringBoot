...
public class RpcServer implements ApplicationContextAware, InitializingBean {
    ...
    public void afterPropertiesSet() {
        this.executor = new ThreadPoolExecutor(corePoolSize, maximumPoolSize, keepAliveTime, TimeUnit.MILLISECONDS, new ArrayBlockingQueue<Runnable>(128), new RpcThreadFactory());
        new Thread(() -> {
            try {
                this.run();
            } catch (IOException e) {
